    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-2xl px-5">
        ...
        <section className="pt-8 pb-4">
          ...
          />
          <h1 className="mt-8 text-center text-4xl font-bold leading-tight tracking-tight">
          ...
          <div className="mt-8 flex justify-center">
            <button className="group inline-flex items-center gap-2 rounded-full bg-brand px-10 py-4 text-base font-semibold text-brand-foreground shadow-[var(--shadow-cta)] transition-transform active:scale-95">
              Start Survey Now
            ...
            {faqs.map((f, i) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span className={`font-semibold ${isOpen ? "text-brand" : "text-foreground"}`}>
                      {f.q}
                    </span>
                    <ChevronDown
        ...
        <section className="py-8">
          <h2 className="text-center text-2xl font-bold">Simple 3-Step Process</h2>
        ...
        <section className="py-10">
          <h2 className="text-center text-2xl font-bold">Why People Trust This Program</h2>
      ...
      <footer className="mt-8 bg-footer py-8 text-center text-sm text-footer-foreground">
